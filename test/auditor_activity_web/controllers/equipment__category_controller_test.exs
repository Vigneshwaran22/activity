defmodule AuditorActivityWeb.Equipment_CategoryControllerTest do
  ...
  describe "update equipment_category" do
    ...
    test "renders equipment_category when data is valid", %{conn: conn, equipment_category: %Equipment_Category{id: id} = equipment_category} do
